...
Section "SGCT ${SGCT_VERSION} ${SGCT_COMPILER} ${ARCH}"
	...
	!else if "${ARCH}" == "x64"
		File "..\..\lib\${SGCT_COMPILER}_${ARCH}\sgct64.lib"
		File "..\..\lib\${SGCT_COMPILER}_${ARCH}\sgct64_d.lib"
	!endif
	...
	File "..\..\bin\postProcessing\${SGCT_COMPILER}\postProcessing_${SGCT_COMPILER}_${ARCH}.exe"
...
Section "Start Menu Shortcuts"
  ...
  SetOutPath "$INSTDIR\SGCT_${SGCT_VERSION}_${ARCH}\examples\height_mapping"
  CreateShortCut "$SMPROGRAMS\SGCT\examples\height_mapping_FXAA.lnk" "$INSTDIR\SGCT_${SGCT_VERSION}_${ARCH}\examples\height_mapping\heightMappingExample_${SGCT_COMPILER}_${ARCH}.exe" "-config $\"%SGCT_ROOT_DIR%\config\single.xml$\" --FXAA"
  ...
  CreateShortCut "$SMPROGRAMS\SGCT\examples\simple_navigation_fisheye_FXAA.lnk" "$INSTDIR\SGCT_${SGCT_VERSION}_${ARCH}\examples\simple_navigation\simpleNavigationExample_${SGCT_COMPILER}_${ARCH}.exe" "-config $\"%SGCT_ROOT_DIR%\config\single_fisheye.xml$\" --FXAA"
