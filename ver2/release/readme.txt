...
The four libraries are compiled with other settings for providing compability with different types of third party libs and frameworks.
...
To run the examples don’t forget to put textures, shaders and models in the build directory.
